...
describe('LoginSection', () => {
  describe('Passing props to LoginBtn Child', () => {
    it('should pass "false" to LoginBtn when given undefined userId.', () => {
      ...
      expect(shallowResult.props.children).toContainEqual(<LoginBtn currentlyLoggedIn={false} />);
    });
    ...
    it('should pass "true" to LoginBtn when userId is not null.', () => {
      ...
      expect(shallowResult.props.children).toContainEqual(<LoginBtn currentlyLoggedIn={true} />);
    });
