...
urlpatterns = [
    ...
    url(regex=r'v3/create_report$', view=views.create_report_v3, name="create_report_v2"),
    url(regex=r'v3/update_report$', view=views.update_report, name="update_report"),
    ...
    url(regex=r'v2/update_report$', view=views.update_report, name="update_report"),
    url(regex=r'v2/attach_file$', view=views.attach_file_v2, name="attach_file_v2"),
    # API v1
    url(regex=r'get_by_code/(?P<code>[0-9]{8,13})$', view=views.get_by_code, name="get_by_code"),
