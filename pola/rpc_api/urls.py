...
urlpatterns = [
    ...
    url(regex=r'v3/update_report$', view=views.update_report, name="update_report_v3"),
    # API v2
    ...
    url(regex=r'v2/update_report$', view=views.update_report, name="update_report_v2"),
