...
class TestHome(PermissionMixin, TestCase):
    ...
    def test_generate_report(self):
        ...
        CompanyFactory(plCapital=100, plWorkers=100, plRnD=100, plRegistered=100, plNotGlobEnt=100, query_count=100)
        ...
        self.assertEqual(
            [
                {
                    'common_name': 'company_official_1',
                    'official_name': 'company_official_1',
                    'name': 'company1',
                    'nip': '',
                    'query_count': '100',
                    'count_product_id': '0',
