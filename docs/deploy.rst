...
.. code-block:: bash
    ...
    heroku config:set POLA_APP_GCS_PUBLIC_BUCKET_NAME=YOUR_POLA_APP_GCS_PUBLIC_BUCKET_NAME_HERE
    heroku config:set POLA_APP_GCS_BACKEND_BUCKET_NAME=YOUR_POLA_APP_GCS_BACKEND_BUCKET_NAME_HERE
    heroku config:set POLA_APP_GCS_AI_PICS_BUCKET_NAME=YOUR_POLA_APP_GCS_AI_PICS_BUCKET_NAME_HERE
    heroku config:set POLA_APP_GCS_WEB_BUCKET_NAME=YOUR_POLA_APP_GCS_WEB_BUCKET_NAME_HERE
    heroku config:set POLA_APP_GCS_COMPANY_LOGOTYPE_BUCKET_NAME=YOUR_POLA_APP_GCS_COMPANY_LOGOTYPE_BUCKET_NAME_HERE
