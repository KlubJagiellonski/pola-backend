        ...
        <ContentColumn fraction={60}>
          <PageSection>
            ...
            <Text>
              ...
              przyczyni się do popularyzacji mody na patriotyzm gospodarczy. Stworzyliśmy narzędzia wsparcia biznesu,
              które odzwierciedlają aktualne nawyki konsumenckie i pozwalają uzyskać przewagę konkurencyjną.
            </Text>
            ...
            <Text>
              ...
              To proste narzędzie służące do weryfikowania firm. Aplikacja przyznaje punkty od 0 do 100. Maksymalną
              liczbę punktów uzyskuje firma, która produkuje w Polsce, jest tutaj zarejestrowana, ma polski kapitał i
              nie jest częścią zagranicznego koncernu. Ponieważ zdecydowana większość Polaków chce kupować polskie
              produkty, warto podkreślać ich pochodzenie na opakowaniu. Nasz znak towarowy jest skierowany do wszystkich
          ...
          <PageSection>
            ...
            <Text>
              ...
              Ciebie listę kodów EAN, listę marek własnych, lub zupełnie inne dane, których jeszcz e nie mamy. Budujmy
              razem świadomą konsumpcję.
            </Text>
          </PageSection>
          <PageSection>
